package com.project.ecommerce.domain.v2;

import java.util.Date;

public abstract class StorableWebObject implements WebObject {

    /*Attribute for storing an object*/
    private long id;
    private Date dateCreated;
    private Date lastUpdated;

    /*Attributes for the generation of default uuid*/
    private String key;
    protected String uuid;

    /*to avoid the code duplication. I,age attribute*/
